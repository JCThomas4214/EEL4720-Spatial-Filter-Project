function [rows, cols] = brom_gen(infile, coeR, coeP, coeQ, numrows, numcols)
...
for r = 1:8128
		...
		r0=a(number,1);
        if(r==8128)
           fprintf(fid7,'%02x%02x%02x%02x%02x%02x%02x%02x\n',r7,r6,r5,r4,r3,r2,r1,r0);
        else 
        fprintf(fid7,'%02x%02x%02x%02x%02x%02x%02x%02x,\n',r7,r6,r5,r4,r3,r2,r1,r0);
        end
        count = count+1;
...
for r = 1:8128
		...
		r0=b(number,1);
        if(r==8128)
           fprintf(fid8,'%02x%02x%02x%02x%02x%02x%02x%02x\n',r7,r6,r5,r4,r3,r2,r1,r0);
        else 
        fprintf(fid8,'%02x%02x%02x%02x%02x%02x%02x%02x,\n',r7,r6,r5,r4,r3,r2,r1,r0);
        end
        count = count+1;
...
for r = 1:8128
		...
		r0=cc(number,1);
        if(r==8128)
           fprintf(fid9,'%02x%02x%02x%02x%02x%02x%02x%02x\n',r7,r6,r5,r4,r3,r2,r1,r0);
        else 
        fprintf(fid9,'%02x%02x%02x%02x%02x%02x%02x%02x,\n',r7,r6,r5,r4,r3,r2,r1,r0);
        end
        count = count+1;
