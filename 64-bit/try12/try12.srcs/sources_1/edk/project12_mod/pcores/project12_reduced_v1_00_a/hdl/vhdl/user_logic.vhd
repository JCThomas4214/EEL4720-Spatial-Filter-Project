...
-- Date:              Thu Apr 23 13:30:50 2015 (by Create and Import Peripheral Wizard)
...
port(	clk: 		IN std_logic;
		...
		rdata_out:OUT std_logic_vector(63 downto 0);
		raddr_out:IN std_logic_vector(12 downto 0);
		rd_en		:IN std_logic;
  ...
  signal slv_reg_write_sel              : std_logic_vector(19 downto 0);
  signal slv_reg_read_sel               : std_logic_vector(19 downto 0);
  signal slv_ip2bus_data                : std_logic_vector(C_SLV_DWIDTH-1 downto 0);
  signal slv_read_ack                   : std_logic;
  signal slv_write_ack                  : std_logic;
  signal total_data							 : std_logic_vector(63 downto 0) := (others => '0');
...
TOP: top_level
	...
	rdata_out=>total_data,
	raddr_out=>slv_reg6(12 downto 0),
	rd_en=>slv_reg7(0),
	timingCount=>slv_reg19);
	
	slv_reg9 <= total_data(31 downto 0);
	slv_reg10 <= total_data(63 downto 32);
  ------------------------------------------
  ...
  -- 
  ------------------------------------------
  slv_reg_write_sel <= Bus2IP_WrCE(19 downto 0);
  slv_reg_read_sel  <= Bus2IP_RdCE(19 downto 0);
