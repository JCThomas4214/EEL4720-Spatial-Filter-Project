...
Peripheral Summary:
  ...
  logical library name                       : project11_timer_v1_00_a
  top name                                   : project11_timer
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- XPS interface file(s)
  ...
  data/project11_timer_v2_1_0.mpd
  ...
  data/project11_timer_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/project11_timer.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/project11_timer_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/project11_timer_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/project11_timer_v2_1_0.tcl
